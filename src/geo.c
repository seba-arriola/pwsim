...
{
    static const double EARTH_RADIUS = 6378.160;      // km
    static const double E2  = 6.6946053e-3;           // eccentricity squared
    static const double E12 = 6.7397251e-3;

    double A=EARTH_RADIUS, D=57.29578, RD=1.0/57.29578;
    ...
    double C1 = D/R;
    double C2 = D/AN;
    *x = M_PER_KM*AL*CLAT/C2*( 1.0 + AL*AL*cos(2.0*RLAT)/(6.0*D*D) );
    *y = M_PER_KM*(PH1 - ALATO)/C1;
...
{
    static const double EARTH_RADIUS = 6378.160;      // km
    static const double E2  = 6.6946053e-3;
    static const double E12 = 6.7397251e-3;

    double y_aux=y/M_PER_KM;
    double x_aux =x/M_PER_KM;
    double A=EARTH_RADIUS, D=57.29578, RD=1.0/57.29578;
